...
// =================== PRICING ===================
function Pricing({ visible }) {
  if (!visible) return null;
  return (
    <section className="section section-tinted" id="pricing">
      <div className="container">
        <div style={{ textAlign: 'center', marginBottom: 64 }}>
          <div className="section-eyebrow" style={{ justifyContent: 'center' }}>Precios</div>
          <h2 className="section-title" style={{ margin: '0 auto 24px', textAlign: 'center' }}>
            Empieza gratis.<br />
            <span style={{ color: 'var(--accent-live)', fontStyle: 'italic', fontWeight: 500 }}>Crece cuando quieras.</span>
          </h2>
          <p className="section-lead" style={{ margin: '0 auto' }}>
            Sin tarjeta, sin compromiso. Plan Free para siempre — Plan Pro cuando tu negocio lo pida.
          </p>
        </div>
