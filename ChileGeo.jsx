// ChileGeo.jsx — datos administrativos de Chile (regiones y sus comunas).
// Módulo compartido: lo expone en window.CHILE_REGIONES para usarlo en los
// selects dependientes Región → Comuna. Orden norte a sur.
...
// Comunas de una región (por nombre exacto). [] si no se encuentra.
function comunasDeRegion(region) {
  const r = CHILE_REGIONES.find(x => x.region === region);
  return r ? r.comunas : [];
}

Object.assign(window, { CHILE_REGIONES, comunasDeRegion });
